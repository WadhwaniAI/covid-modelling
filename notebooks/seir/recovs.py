...
def smooth_using_active(df_district, df_district_raw_data=None, last_n_days=60):
    ...
    # trunc['recovered'] = trunc['recovered'] + recovs_to_redistribute - trunc['new_recovered']
    trunc['hospitalised'] = trunc['hospitalised'] + trunc['new_hospitalised'].cumsum()
    # trunc['hospitalised'] = trunc['hospitalised'] + active_to_redistribute - trunc['new_hospitalised']
