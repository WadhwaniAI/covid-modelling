...
def init_params(R0 = 2.2, T_inf = 2.9, T_inc = 5.2, T_hosp = 5, T_death = 32, P_severe = 0.2, P_fatal = 0.02, T_recov_severe = 14, 
                ...
                positive_test_rate_for_infected = 1, lockdown_removal_day = 45 ):
