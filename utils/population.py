...
def standardise_age_1(district_timeseries, age_data, district, state, area_names):
    data = district_timeseries.set_index('date')
    raw_all_district_age_data = age_data[state]

    all_district_age_data = clean_indian_census(raw_all_district_age_data)
    ...
    # daily_observed_mortality = data['deceased']/data['total_confirmed']
    daily_observed_mortality = data['deceased']/district_total_pop
