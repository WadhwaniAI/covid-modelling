...
class JHULoader(BaseLoader):
    ...
    def _load_from_daily_reports(self):
        ...
        main_url = 'https://raw.githubusercontent.com/CSSEGISandData/COVID-19/master/csse_covid_19_data/csse_covid_19_daily_reports_us/{}.csv'
    ...
    def _load_data_from_time_series_global(self):
        ...
        """
        main_url = 'https://raw.githubusercontent.com/CSSEGISandData/COVID-19/master/csse_covid_19_data/csse_covid_19_time_series/time_series_covid19_{}_global.csv'
...
if __name__ == '__main__':
    obj = JHULoader()
    df_states = obj._load_from_daily_reports()
