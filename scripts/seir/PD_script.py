...
with open('../../misc/predictions/PD_truncated_logdiff_gibbs_oct.pickle', 'wb') as handle:
    pkl.dump(PD, handle)


# %%
with open('../../misc/predictions/PD_truncated_logdiff_gibbs_oct.pickle', 'rb') as handle:
    PD = pkl.load(handle)
