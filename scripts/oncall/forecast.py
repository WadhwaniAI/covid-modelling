...
with open(f'../../misc/reports/{args.folder}/deciles_idx.json', 'w+') as params_json:
...
pd.DataFrame(forecast_dict['decile_params']).to_csv(f'../../misc/reports/{args.folder}/deciles-params.csv')
...
ax.figure.savefig(f'../../misc/reports/{args.folder}/deciles.png')
...
forecast_dict['what-ifs-plot'].figure.savefig(f'../../misc/reports/{args.folder}/what-ifs/what-ifs.png')

create_report(region_dict, forecast_dict=forecast_dict, ROOT_DIR=f'../../misc/reports/{args.folder}')
print(f"lit. done: view files at ../../misc/reports/{args.folder}/")
