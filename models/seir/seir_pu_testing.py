...
class SEIR_PU_Testing(SEIR):
    ...
    def get_derivative(self, t, y):
        ...
        dydt[2] = (1 / self.T_inc)*E - I / self.T_inf_U - tests_done*self.d*self.psi  # I
        dydt[3] = I / self.T_inf_U  # P_U
        dydt[4] = (self.P_severe*tests_done*self.d*self.psi) - R_severe/self.T_recov #R_severe
        dydt[5] = (self.P_fatal*tests_done*self.d*self.psi) - R_fatal/self.T_recov_fatal # R_fatal
