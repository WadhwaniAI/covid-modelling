...
class SEIR_Movement_Testing():
    ...
    def get_derivative(self, t, y):
        ...
        dydt[0] = - I * S / (self.T_trans) - (self.q / self.T_trans_D) * (S * D_I)  - self.mu*S
        dydt[1] = I * S / (self.T_trans) + (self.q / self.T_trans_D) * (S * D_I) - (E/ self.T_inc) - (theta_E * psi_E * E)  - self.mu*E
        dydt[2] = E / self.T_inc - I / self.T_inf - (theta_I * psi_I * I) -  - self.mu*I
