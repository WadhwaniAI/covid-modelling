...
class SEIR_Movement_Testing(SEIR):
    ...
    def get_derivative(self, t, y):
        ...
        dydt[0] = - I * S / (self.T_trans) - (self.q / self.T_trans_D) * (S * D_I) - (self.mu*S) # S
        dydt[1] = I * S / (self.T_trans) + (self.q / self.T_trans_D) * (S * D_I) - (E/ self.T_inc) - (self.theta_E * self.psi_E * E) - (self.mu*E) # E
