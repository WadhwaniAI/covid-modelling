...
class SEIR_Undetected(SEIR):
    def __init__(self, pre_lockdown_R0=3, lockdown_R0=2.2, post_lockdown_R0=None, T_inf_D=3.3, T_inf_U = 5.5, T_inc=5, T_recov_fatal=32,
                 P_severe=0.2, P_fatal=0.02, T_recov_severe=14, T_recov_mild=11, N=1.87e7, d=0.011, psi=1.00,
        ...
        p_params['P_mild'] = 0  # Doubt: Do we need to keep this for this model as well?
